      ...
      if (!e.target.matches('.dropbtn')) {
        ...
        <div id="wrapper_top10">
            <div class="columns_top10">
                ...
                <h2>Number 5</h2>
                <h3> INSIDE - Score: 9.1 </h3>
                <img src="Images/inside.jpg" style="width: 675px; height: 400px;  ">
                ...
                <h2>Number 4 </h2>
                <h3> Dark Souls 3 - Score: 9.3 </h3>
                <img src="Images/ds.jpg" style="width: 675px; height: 400px;  ">
                <p>If Dark Souls 3 truly is the last in the series as we know it, then it’s a worthy send-off. Weapon arts allow stylish and versatile new moves without tarnishing the purity of the combat system. Lothric’s awe-inspiring locations provide visually stunning arenas for rigorous exploration and fierce face-offs with hosts of deadly enemies and even deadlier bosses. While not all the risky changes land as neatly as others, Dark Souls 3 is a powerful journey and the sequel the series truly deserves. A must play for action game lovers out there, and a solid 9.3.</p>

                <h2>Number 3</h2>
                <h3>Doom - Score 9.4</h3>
                <img src="Images/doom.jpg" style="width: 675px; height: 400px;">
                ...
                <h2>Number 2</h2>
                <h3>Quadrilateral Cowboy - Score: 9.6</h3>
                <img src="Images/cowboy.jpg" style="width: 675px; height: 400px;">
                <p>Quadrilateral Cowboy’s puzzles are mostly a joy to play. Its command line hacking is surprisingly accessible and pleasingly tactile, and when combined with its many interesting gadgets it allows for plenty of creative problem-solving and freedom in tackling all manner of whimsical cybercrime. While not all of its levels shine as brightly as the rest, I’m already feeling beckoned back by its replayability and charm, eager to experiment more with the futuristic, hacker-themed playground it so stylishly constructs. This intrigued are interest, and we recommend this for you to try as well. This game gets the number 2 spot with a score of 9.6! </p>

                <h2>Number 1</h2>
                <h3>Total War: Warhammer - Score: 10</h3>
                <img src="Images/war.jpg" style="width: 675px; height: 400px;">
                <p>Total War: Warhammer is brimming with exciting ideas, interesting characters, and outright, skull-stompingly delightful units and faction mechanics. The current roster of starting positions in the campaign feels thin, but each army therein is a distinctly different experience. Some factions (Vampire Counts, Greenskins) are more fun than others (Dwarfs), but none feel underdeveloped or unfinished. Deep hero progression and a well-executed Chaos invasion round out a campaign that, while it has some flaws in set-up and pacing, fulfilled all of my deepest fantasies of seeing giant, impossible armies clashing amidst the shrieking of griffins and the glow of flaming meteors summoned from the sky. It’s just a damn good time. This game grabs our top spot at number 1 with a perfect score of 10!</p>
